...
public class ProductController {
    ...
    public Product afficherUnProduit(@PathVariable int id) {
        ...
        if (produit == null)
            throw new ProduitIntrouvableException("Le produit avec l'id " + id + " est INTROUVABLE. Écran Bleu si je " +
                    "pouvais.");
    ...
    public Map<Product, Integer> calculerMargeProduit() {
        Iterable<Product> produits = productDao.findAll();
        Map<Product, Integer> margeProduits = new LinkedHashMap<Product, Integer>();
